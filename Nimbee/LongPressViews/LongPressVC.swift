...
extension LongPressVC: JZBaseViewDelegate {
...
// LongPress core
extension LongPressVC: JZLongPressViewDelegate, JZLongPressViewDataSource {
...
// For example only
extension LongPressVC: OptionsViewDelegate {
    ...
    @objc func presentOptionsVC() {
        guard let optionsVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "OptionsViewController") as? ExampleOptionsVC else {
            return
        }
